...
x1measure   = [+30.000 +0.000 +10 cen_mid_lane]; 
x2measure   = [+16.0 +0.000 +60 cen_mid_lane];
...
for iter=1:125
    ...
    [t01, x1measure, u01] = nmpc(@runningcosts1v21, @terminalcosts1v1, @constraints1, ...
    ...
    % update ego vehicle control signal and state
